...
const About = () => {
  ...
  const [bg, setBg] = useState("01.png");
          ...
          <article className={Style.profile_about}>
            <figure>
              <div className={Style.profile_img_container}>
                <div
                  className={Style.profile_img_wrap}
                  style={{ backgroundImage: `url("/img/introimg/${bg}")`, backgroundSize: "130% 130%", border: "none", backgroundPosition: "center center" }}
                >
                  <img src="/img/profile/300.png" alt="profile image" />
                </div>
              ...
              <figcaption className={specialOn ? `${Style.profile_info_container} ${Style.on}` : Style.profile_info_container}>
                <p className={Style.profile_info}> 자기소개 내용 </p>
                <p className={Style.profile_special}>{specialEvent}</p>
              </figcaption>
            </figure>
          </article>
        </section>
